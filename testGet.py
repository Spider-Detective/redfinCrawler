...
URL = 'https://www.redfin.com/CA/Irvine/10-Skipper-92604/home/4675738'
...
img_ul = soup.find_all('div', {"class": "school-title"})
print(img_ul[0].string)
rating = soup.find_all('span', {"class": "rating-num"})
